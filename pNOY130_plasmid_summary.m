...
[s.wt.all_rhos, s.wt.all_stds] = dir_rhos('KBY6317 ND', '*.nd2');
[s.gal.all_rhos, s.gal.all_stds] = dir_rhos('KBY6413_NOY988 ND', 'gal*.nd2');
[s.glu.all_rhos, s.glu.all_stds] = dir_rhos('KBY6413_NOY988 ND', '5hglu*.nd2');
